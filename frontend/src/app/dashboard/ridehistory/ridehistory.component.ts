...
export class RidehistoryComponent implements OnInit, OnDestroy {
  ...
  getRideHistory() {
    ...
    const rideHistorySubscription = this._socket.listenridehistory().subscribe((data: any) => {
      console.log(data);
    ...
    this.subscriptions.add(rideHistorySubscription)
  }
  ...
  aftercancelrideinrealtime(){
    const cancelRideSubscription = this._socket.listencancelride().subscribe((ridedata: any) => {
      this.getRideHistory()
    })
  ...
  ridestatusupdates(){
    const rideUpdateSubscription = this._socket.listeningrideupdates().subscribe((ridedata: any) => {
      this.getRideHistory()
    })
